...
public class ListofdriversUI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ambList.add(new Ambulance_driver(R.drawable.ambtn,"Mr.Saravana","James Speciality Hospital","Chennai"));
        ambList.add(new Ambulance_driver(R.drawable.ambtn,"Mr.Ramesh Babu","M.M Ambulance Service","Kancheepuram"));
        ...
        ambList.add(new Ambulance_driver(R.drawable.ambtn,"Mr.Britto","Rajeev Hospital","Dindigul"));
